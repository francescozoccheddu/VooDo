...
namespace VooDo.WinUI.Animators
{
    ...
    public abstract class SpringAnimator<TValue> : TargetedAnimator<TValue> where TValue : notnull
    {
        ...
        public abstract record SpringFactory<TAnimator>(TValue Target, double Stiffness, double Damping, double Mass, double MinVelocity) : TargetedFactory<TAnimator>(Target) where TAnimator : SpringAnimator<TValue>
        {
    ...
    public sealed class DoubleSpringAnimator : SpringAnimator<double>, IAnimatorWithVelocity<double>
    {
        ...
        public sealed record DoubleSpringFactory(double Target, double Stiffness, double Damping, double Mass, double MinVelocity) : SpringFactory<DoubleSpringAnimator>(Target, Stiffness, Damping, Mass, MinVelocity)
        {
