namespace VooDo.WinUI.Generator
{
    ...
    public static class Identifiers
    {
        ...
        public const string propertyScriptPrefix = "PropertyScript_";
        public const string classScriptPrefix = "ClassScript_";
        public const string classSourceTag = "Source";
        public const string classTagTag = "Tag";
        public const string propertyCodeTag = "Code";
        public const string propertyPropertyTag = "Property";
        public const string propertyObjectTag = "Object";
        public const string classThisVariableName = "this";
        public const string propertyThisVariableName = "this";
        public const string propertyRootVariableName = "root";
        ...
        internal const string markupObjectName = "VooDo";
