...
namespace VooDo.Transformation
{
    ...
    public static class BodyValidator
    {
        ...
        private sealed class Walker : CSharpSyntaxWalker
        {
            ...
            public override void VisitCompilationUnit(CompilationUnitSyntax _node) => EmitDiagnostic(_node);
            ...
            public override void VisitEnumDeclaration(EnumDeclarationSyntax _node) => EmitDiagnostic(_node);
            public override void VisitEnumMemberDeclaration(EnumMemberDeclarationSyntax _node) => EmitDiagnostic(_node);
            ...
            public override void VisitForStatement(ForStatementSyntax _node) => EmitDiagnostic(_node);
            ...
            public override void VisitReturnStatement(ReturnStatementSyntax _node) => EmitDiagnostic(_node);
            ...
            public override void VisitTypeParameter(TypeParameterSyntax _node) => EmitDiagnostic(_node);
            public override void VisitTypeParameterConstraintClause(TypeParameterConstraintClauseSyntax _node) => EmitDiagnostic(_node);
            public override void VisitTypeParameterList(TypeParameterListSyntax _node) => EmitDiagnostic(_node);
            public override void VisitUndefDirectiveTrivia(UndefDirectiveTriviaSyntax _node) => EmitDiagnostic(_node);
            public override void VisitUnsafeStatement(UnsafeStatementSyntax _node) => EmitDiagnostic(_node);
            public override void VisitUsingDirective(UsingDirectiveSyntax _node) => EmitDiagnostic(_node);
